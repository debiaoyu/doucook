...
- Python 3.10+
- Node.js 18+
- [dousub](https://github.com/debiaoyu/dousub) 命令行工具（`pip install dousub`）
...
| 外部依赖 | [dousub](https://github.com/debiaoyu/dousub) SDK（抖音视频检测、AI 总结、批量导入） |
...
本软件仅供个人学习和研究使用，请勿用于任何商业用途。使用本软件时，请遵守相关平台的服务条款和法律法规。用户应对其使用行为自行承担所有责任。
